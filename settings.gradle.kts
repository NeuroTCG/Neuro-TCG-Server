pluginManagement {
    repositories { mavenLocal(); mavenCentral(); google(); gradlePluginPortal(); maven { url = uri("https://maven.pkg.jetbrains.space/public/p/kotlinx-html/maven") } }
}
...
rootProject.name = "Neuro-TCG-server"
